...
//           <button
//             onClick={logout}
//             className="mt-6 flex items-center gap-4 px-4 py-3 text-red-600 hover:bg-red-50 rounded-xl w-full"
//           >
//             <div className="h-9 w-9 flex items-center justify-center rounded-lg bg-red-100">
//               <LogOut size={18} />
//             </div>
