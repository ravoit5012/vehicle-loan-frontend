...
//                 <div>
//                     <h2 className="text-2xl font-bold text-gray-900">View the Repayments</h2>
//                     <p className="text-gray-600 mt-1">
//                         Keep a track of all repayments scheduled in the nearby future
//                     </p>
//                 </div>
//             </div>
//             <div className="relative border-2 rounded-xl p-2 md:w-[50vw] max-w-125 mx-auto">
