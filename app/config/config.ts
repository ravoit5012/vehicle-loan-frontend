...
export const API_ENDPOINTS = {
  ...
  CHECK_DUPLICATE_VEHICLE: `${BASE_URL}/loan/check-duplicate-vehicle`,
  UPDATE_LOAN_INFO: `${BASE_URL}/loan/update-info`,
  VERIFY_VEHICLE: `${BASE_URL}/loan/verify-vehicle`,
  UPDATE_VEHICLE: `${BASE_URL}/loan/udpate-vehicle`,
