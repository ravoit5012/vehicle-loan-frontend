...
export default function ManagerForm() {
  ...
  return (
    <div className="bg-white/70 backdrop-blur-2xl border border-white/60 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-3xl p-8 md:p-12 space-y-8 transition-all duration-300">
